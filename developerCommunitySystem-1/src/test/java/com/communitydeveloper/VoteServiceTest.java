...
public class VoteServiceTest {
    ...
    public void testGetAllVotes() {
        ...
        when(modelMapper.map(any(Vote.class), eq(VoteDTO.class))).thenReturn(new VoteDTO(/* initialize with test data */));
 
        // Act
        Page<VoteDTO> resultVotePage = voteService.getAllVotes(page, pageSize);
